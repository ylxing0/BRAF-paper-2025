...
#################
pdf("plotCounts_CSC_normalized.pdf", height=6, width=15)
par(mfrow=c(2,3))
plotCounts(dds, gene="ENSG00000132688", normalized=TRUE, intgroup="conditions") #Nes
plotCounts(dds, gene="ENSG00000181449", normalized=TRUE, intgroup="conditions") #Sox2
plotCounts(dds, gene="ENSG00000111704", normalized=TRUE, intgroup="conditions") #Nanog
plotCounts(dds, gene="ENSG00000204531", normalized=TRUE, intgroup="conditions") #Pou5f1
plotCounts(dds, gene="ENSG00000007062", normalized=TRUE, intgroup="conditions") #Prom1
plotCounts(dds, gene="ENSG00000026508", normalized=TRUE, intgroup="conditions") #CD44
dev.off()

###################
pdf("plotCounts_OL.pdf", height=10, width=20)
par(mfrow=c(3,4))
plotCounts(dds, gene="ENSG00000134853", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000173546", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000114646", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000184221", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000205927", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000100146", intgroup="conditions")
plotCounts(dds, gene="ENSG00000149294", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000144230", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000054983", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000154928", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000169851", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000005513", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000106688", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000123560", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000173786", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000126861", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000184226", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000164687", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000112531", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000013297", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000105695", intgroup="conditions")
plotCounts(dds, gene="ENSG00000204655", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000197971", intgroup="conditions") 
plotCounts(dds, gene="ENSG00000124920", intgroup="conditions")
dev.off()
...
OL_genes <- c("PDGFRA","CSPG4","CSPG5","OLIG1","OLIG2","SOX10","NCAM1","GPR17",
              "GALC","EPHB1","PCDH7","SOX8","SLC1A1","PLP1","CNP","OMG","PCDH9",
              "FABP5","QKI","CLDN11","MAG","MYRF","MOG","MBP")
temp <- lcpm[OL_genes,]
write.csv(temp,"human_OL_genes_list.csv")

pdf("heatmap_OLgenes_hs48hrs.pdf", height=8, width=6)
heatmap.2(as.matrix(temp),main="OL_genes",
          scale="row", trace="none", key=TRUE,density.info=c("none"),
          distfun = function(x) as.dist(1-cor(t(x))),
          hclustfun = function(x) hclust(x, method="ward.D2"),
          dendrogram="row", srtCol=45, cexCol =1, cexRow=1,
          margins = c(7, 8), Colv=FALSE,
          col=colorRampPalette( rev(brewer.pal(9, "RdBu")) )(255))
dev.off()
